...
export function mapDailySessionFromRow(row: Row): DailySession {
  return {
    ...
    openingReading: asMetadata(row.opening_reading),
    capacityReading: asMetadata(row.capacity_reading),
    directionReading: asMetadata(row.direction_reading),
    attentionSummary: optionalString(row.attention_summary),
    sessionStatus: row.session_status as DailySession['sessionStatus'],
...
export function mapDailySessionToRow(session: DailySession) {
  return {
    ...
    opening_reading: session.openingReading ?? {},
    capacity_reading: session.capacityReading ?? {},
    direction_reading: session.directionReading ?? {},
    attention_summary: session.attentionSummary,
    session_status: session.sessionStatus ?? 'open',
